  ...
  return (
    <main className="min-h-screen bg-gradient-to-br from-primary-light via-background to-white py-10 px-4">
      <div className="max-w-lg mx-auto">
          ...
          <div className="pt-18 pb-8 px-6 space-y-6">
            ...
            <div className="text-center pt-4">
              ...
              <p className="text-muted-fg mt-1">
                {profile.gender} · {profile.birthYear} · {profile.region}
              </p>
            </div>

            {/* Info grid */}
            <div className="grid grid-cols-2 gap-4">
              <InfoCard label="키" value={profile.height} />
        ...
        <p className="text-center text-xs text-muted-fg/50 mt-6">
          OURMO · 이 링크는 생성일로부터 5일 후 만료됩니다
        </p>
      </div>
    </main>
  );
