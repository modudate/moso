...
const SEED_IDEAL_TYPES: IdealType[] = [
  { userId: "f-001", idealAge: "1996년~1994년", idealMinHeight: 176, idealMaxHeight: 180, idealCities: ["서울"], idealWorkplaces: ["대기업"], idealJobs: [], idealSalaries: ["6,000 ~ 8,000만원"], idealEducation: ["4년제 대학 졸업"], idealSmoking: false, idealMbti: [], topPriorities: ["키", "직장", "연봉", "학력"] },
  { userId: "f-002", idealAge: "1996년~1994년", idealMinHeight: 171, idealMaxHeight: 175, idealCities: ["경기"], idealWorkplaces: ["중견기업"], idealJobs: [], idealSalaries: ["4,000 ~ 6,000만원"], idealEducation: ["대학원 졸업(석사)"], idealSmoking: false, idealMbti: [], topPriorities: ["학력", "흡연", "거주지", "연봉"] },
  { userId: "f-003", idealAge: "1996년~1994년", idealMinHeight: 176, idealMaxHeight: 180, idealCities: ["서울"], idealWorkplaces: ["전문직"], idealJobs: [], idealSalaries: ["8,000 ~ 1억원"], idealEducation: ["4년제 대학 졸업"], idealSmoking: false, idealMbti: [], topPriorities: ["연봉", "학력", "키", "직장"] },
  { userId: "f-004", idealAge: "1996년~1994년", idealMinHeight: 176, idealMaxHeight: 185, idealCities: ["서울"], idealWorkplaces: ["대기업", "전문직"], idealJobs: [], idealSalaries: ["4,000 ~ 6,000만원"], idealEducation: ["4년제 대학 졸업"], idealSmoking: false, idealMbti: ["ENFJ", "ENTJ", "INTJ"], topPriorities: ["MBTI", "키", "직장", "거주지"] },
  // ── 남성 이상형 ──
  { userId: "m-001", idealAge: "1996년~1994년", idealMinHeight: 158, idealMaxHeight: 170, idealCities: ["서울"], idealWorkplaces: ["대기업", "공기업 / 공공기관"], idealJobs: [], idealSalaries: ["4,000 ~ 6,000만원"], idealEducation: ["4년제 대학 졸업", "대학원 졸업(석사)"], idealSmoking: false, idealMbti: ["ENFP", "INFJ"], topPriorities: ["키", "학력", "거주지", "흡연"] },
  { userId: "m-002", idealAge: "1996년~1994년", idealMinHeight: 160, idealMaxHeight: 172, idealCities: ["서울", "경기"], idealWorkplaces: ["전문직"], idealJobs: [], idealSalaries: ["6,000 ~ 8,000만원"], idealEducation: ["4년제 대학 졸업"], idealSmoking: false, idealMbti: [], topPriorities: ["연봉", "학력", "직장", "키"] },
  { userId: "m-003", idealAge: "1996년~1994년", idealMinHeight: 155, idealMaxHeight: 165, idealCities: ["서울"], idealWorkplaces: ["대기업", "중견기업"], idealJobs: [], idealSalaries: ["3,000 ~ 4,000만원"], idealEducation: ["4년제 대학 졸업"], idealSmoking: false, idealMbti: ["ESFP", "ENFP", "ISFJ"], topPriorities: ["MBTI", "거주지", "흡연", "키"] },
  { userId: "m-004", idealAge: "1996년~1994년", idealMinHeight: 156, idealMaxHeight: 168, idealCities: ["경기", "서울"], idealWorkplaces: ["공기업 / 공공기관", "대기업"], idealJobs: [], idealSalaries: ["4,000 ~ 6,000만원"], idealEducation: ["대학원 졸업(석사)", "4년제 대학 졸업"], idealSmoking: false, idealMbti: [], topPriorities: ["학력", "거주지", "연봉", "직장"] },
  { userId: "m-lonely", idealAge: "1996년~1994년", idealMinHeight: 160, idealMaxHeight: 175, idealCities: ["서울"], idealWorkplaces: ["대기업", "전문직", "공기업 / 공공기관"], idealJobs: [], idealSalaries: ["4,000 ~ 6,000만원"], idealEducation: ["4년제 대학 졸업"], idealSmoking: false, idealMbti: ["ENFP", "ISFJ", "ESFJ"], topPriorities: ["키", "MBTI", "학력", "거주지"] },
];
